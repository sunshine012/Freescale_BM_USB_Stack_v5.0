...
__vector_table
        ...
        DCD     UART2_ISR                 ;49:  UART 2 intertrupt
        ...
        DCD     CMT_IRQHandler            ;65:  CMT interrupt
        DCD     RTC_alarm_IRQHandler        ;66:  RTC interrupt
        DCD     RTC_seconds_IRQHandler        ;67:  RTC interrupt
        DCD     PIT0_ISR                  ;68:  PIT 0 interrupt
        ...
        DCD     0                            ;86:
        DCD     0             ;87:  PORT A interrupt
        DCD     PORTB_ISR          ;88:  PORT B interrupt
        DCD     0             ;89:  PORT C interrupt
        DCD     0             ;90:  PORT D interrupt
        DCD     0             ;91:  PORT E interrupt
        DCD     0             ;92:  PORT F interrupt
        DCD     0                         ;93:
        DCD     Software_IRQHandler       ;94:
        DCD     NFC_IRQHandler            ;95:
        DCD     USBHS_ISR                 ;96:
        DCD     GLCD_IRQHandler		  ;97:
        DCD     CMP3_IRQHandler	          ;98:
        DCD     Tamper_IRQHandler	  ;99:
        DCD     0			  ;100:
        DCD     FTM3_IRQHandler	          ;101:
        DCD     ADC2_IRQHandler	          ;102:
        DCD     ADC3_IRQHandler	          ;103:
        DCD     I2S1_Tx_IRQHandler	  ;104:
        DCD     I2S2_Rx_IRQHandler        ;105:
