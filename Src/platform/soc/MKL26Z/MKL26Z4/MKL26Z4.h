...
#define MCU_ACTIVE
#define CPU_IS_ARM_CORTEX_M0P     1
...
typedef struct {
  __IO uint8_t RESERVED_0[8];
  __IO uint32_t ACTLR;                                  /**< Auxiliary Control Register,, offset: 0x8 */
  __IO uint8_t RESERVED_1[3316];
  __IO uint32_t CPUID;                                  /**< CPUID Base Register, offset: 0xD00 */
...
/* SystemControl */
#define SCB_ACTLR                                SCB_ACTLR_REG(SCB)
#define SCB_CPUID                                SCB_CPUID_REG(SCB)
#define SCB_ICSR                                 SCB_ICSR_REG(SCB)
#define SCB_VTOR                                 SCB_VTOR_REG(SCB)
#define SCB_AIRCR                                SCB_AIRCR_REG(SCB)
#define SCB_SCR                                  SCB_SCR_REG(SCB)
#define SCB_CCR                                  SCB_CCR_REG(SCB)
#define SCB_SHPR2                                SCB_SHPR2_REG(SCB)
#define SCB_SHPR3                                SCB_SHPR3_REG(SCB)
#define SCB_SHCSR                                SCB_SHCSR_REG(SCB)
#define SCB_DFSR                                 SCB_DFSR_REG(SCB)
