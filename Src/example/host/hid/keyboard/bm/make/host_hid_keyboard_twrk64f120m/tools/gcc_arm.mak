...
#-----------------------------------------------------------
ifeq ($(CONFIG),debug)
LIBRARIES += $(USB_ROOTDIR)/output/twrk64f120m.gcc_arm/debug/usbh/bm/usbh.a
endif
ifeq ($(CONFIG),release)
LIBRARIES += $(USB_ROOTDIR)/output/twrk64f120m.gcc_arm/release/usbh/bm/usbh.a
endif
...
INCLUDE += $(USB_ROOTDIR)/output/twrk64f120m.gcc_arm/debug/usbh/bm
endif
ifeq ($(CONFIG),release)
INCLUDE += $(USB_ROOTDIR)/platform/bsp/twrk64f120m/gcc_arm
INCLUDE += $(USB_ROOTDIR)/output/twrk64f120m.gcc_arm/release/usbh/bm
endif
