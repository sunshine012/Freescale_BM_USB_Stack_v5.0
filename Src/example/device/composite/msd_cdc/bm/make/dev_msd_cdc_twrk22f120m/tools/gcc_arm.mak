...
#-----------------------------------------------------------
ifeq ($(CONFIG),debug)
LIBRARIES += $(USB_ROOTDIR)/output/twrk22f120m.gcc_arm/debug/usbd/bm/usbd.a
endif
ifeq ($(CONFIG),release)
LIBRARIES += $(USB_ROOTDIR)/output/twrk22f120m.gcc_arm/release/usbd/bm/usbd.a
endif
...
#-----------------------------------------------------------
ifeq ($(CONFIG),debug)
INCLUDE += $(USB_ROOTDIR)/platform/bsp/twrk22f120m/gcc_arm
INCLUDE += $(USB_ROOTDIR)/output/twrk22f120m.gcc_arm/debug/usbd/bm
endif
ifeq ($(CONFIG),release)
INCLUDE += $(USB_ROOTDIR)/platform/bsp/twrk22f120m/gcc_arm
INCLUDE += $(USB_ROOTDIR)/output/twrk22f120m.gcc_arm/release/usbd/bm
endif
