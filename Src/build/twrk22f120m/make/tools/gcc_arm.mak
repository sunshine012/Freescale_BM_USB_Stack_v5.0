...
# common settings
AS_FLAGS += -mcpu=cortex-m4 -mfloat-abi=softfp -mfpu=fpv4-sp-d16 -std=gnu99 -Wall -mthumb -g2 -gdwarf-2 -gstrict-dwarf -x assembler-with-cpp 
...
CC_DEFINE += _AEABI_LC_CTYPE=C __STRICT_ANSI__=1 __VFPV4__=1 SDK_USB_HAL_ENABLE=1 CPU_MK22F51212=1 
