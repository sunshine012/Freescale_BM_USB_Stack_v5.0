...
cp -f "${USBROOTDIR}/usb_core/include/compiler.h" "${OUTPUTDIR}/compiler.h"
...
cp -f "${USBROOTDIR}/usb_core/host/include/usb_host_cnfg.h" "${OUTPUTDIR}/usb_host_cnfg.h"
cp -f "${USBROOTDIR}/usb_core/host/include/usb_host_stack_interface.h" "${OUTPUTDIR}/usb_host_stack_interface.h"
cp -f "${USBROOTDIR}/usb_core/host/sources/classes/hid/usb_host_hid.h" "${OUTPUTDIR}/usb_host_hid.h"
cp -f "${USBROOTDIR}/usb_core/host/sources/classes/hub/usb_host_hub.h" "${OUTPUTDIR}/usb_host_hub.h"
cp -f "${USBROOTDIR}/usb_core/host/sources/classes/cdc/usb_host_cdc.h" "${OUTPUTDIR}/usb_host_cdc.h"
cp -f "${USBROOTDIR}/usb_core/host/sources/classes/audio/usb_host_audio.h" "${OUTPUTDIR}/usb_host_audio.h"
cp -f "${USBROOTDIR}/usb_core/host/sources/classes/hub/usb_host_hub_sm.h" "${OUTPUTDIR}/usb_host_hub_sm.h"
cp -f "${USBROOTDIR}/usb_core/host/sources/classes/msd/usb_host_msd_bo.h" "${OUTPUTDIR}/usb_host_msd_bo.h"
cp -f "${USBROOTDIR}/usb_core/host/sources/classes/msd/usb_host_msd_ufi.h" "${OUTPUTDIR}/usb_host_msd_ufi.h"
cp -f "${USBROOTDIR}/usb_core/host/sources/classes/phdc/usb_host_phdc.h" "${OUTPUTDIR}/usb_host_phdc.h"
