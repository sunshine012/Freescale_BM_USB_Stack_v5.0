...
copy usb_core\device\include\twrk70f120m\usb_device_config.h %OUTPUTDIR%\ /Y
...
copy usb_core\host\include\twrk70f120m\usb_host_config.h %OUTPUTDIR%\ /Y
...
copy usb_core\otg\sources\include\usb_otg_main.h %OUTPUTDIR%\ /Y
